...
func _process(delta: float) -> void:
    ...
    var x_jiggle = cos(pedals_jiggle_phase * pedals_jiggle_frequency) * pedals_jiggle_amplitude
    var y_jiggle = sin(pedals_jiggle_phase * pedals_jiggle_frequency) * pedals_jiggle_amplitude
